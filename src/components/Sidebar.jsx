...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <div className="flex items-center gap-3 p-4 border-b border-surface-lighter/40">
          ...
          {!collapsed && (
            <div className="overflow-hidden">
              <h1 className="text-sm font-bold text-text-primary whitespace-nowrap tracking-tight">Fabio IA</h1>
              <p className="text-[10px] text-accent whitespace-nowrap font-medium">Agentes Autonomos de IA</p>
            </div>
          )}
        </div>
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <item.icon size={18} className={`flex-shrink-0 ${isActive ? 'drop-shadow-[0_0_6px_rgba(124,92,252,0.5)]' : ''}`} />
                  {!collapsed && (
                    <div className="overflow-hidden">
